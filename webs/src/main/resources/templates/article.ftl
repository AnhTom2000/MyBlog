                                ...
                                <div class="article-info row">
                                    ...
                                    <div class="article-info article-info-publishDate">
                                        <i class="zi zi_calendar" zico="日历"><a class="articleCategoryColor"
                                                                               href="/archives">
                                        ${article_info.a_createTime} </a></i>
                                    </div>
                                    <div class="article-info article-info-originalAuthor"
                                         id="${article_info.user.userId}">
                                        <i class="zi zi_usergraduate" zico="用户学历"><a id="articleAuther"
                                                                                     href="/user/showUser/${article_info.user.userName}"
                                        >${article_info.user.userName}</a> </i>
                                    </div>
                                        ...
                                        <i class="zi zi_folders" zico="文件夹">
                                                <#list article_info.tags as tag>
                                                    <a class="articleCategoryColor"
                                                       href="/search?type=tag&key=${tag.tag_name}">${tag.tag_name}</a>
                                                </#list></i>
                                    </div>
                                </div>
