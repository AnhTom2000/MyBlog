...
<div class="d-flex align-items-stretch bg-gray-100">
    <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
            ...
            <li class="sidebar-list-item py-3"><a href="/user/PersonalSystem/modifyPassword" class="sidebar-link text-muted"><i
                                ...
                                <div class="userInfo my-5">
                                    <div id="personalDate" class="my-5">
                                        <div class="personalupdate">
                                            <section class="py-5">
                                                <div class="row">
                                                        <#list userArticlePageHelper.data as article>
                                                                ...
                                                                <div href="#"
                                                                    ...
                                                                    <div class="row">
                                                                        <div
                                                                            ...
                                                                            <strong class="h5 mb-0 mr-2">${article_index+1}</strong>
                                                                            <h6 class="mb-0"><a
                                                                                    href="/article/${article.a_id}"
                                                                                    class="articleTitle">${article.a_Title}</a>
                                                                            </h6>
                                                                        </div>
                                                                        <div class="col-lg-5 pl-5 pt-5 d-flex align-items-center flex-column flex-lg-row text-center text-md-left "
                                                                            ...
                                                                            <button type="button"
                                                                                ...
                                                                                <a href="/article/markdown_edit?articleId=${article.a_id}"
                                                                                   style="color: white;text-decoration: none;">编辑</a>
                                                                            </button>
                                                                            <button type="button" id="${article.a_id}"
                                                                                    class="btn btn-danger"
                                                                                    onclick="deleteArticle(this)"
                                                                                    style="margin-right: auto;margin-left: auto;">
                                                                                <a class="${article.a_id}">删除</a>
                                                                            </button>
                                                                        </div>
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                ${(article.a_createTime?string)?replace("T"," ")?datetime("yyyy-MM-dd HH:mm:ss")}</div>
                                                ...
                                                <#if (userArticlePageHelper.data?size>0)>
<div class="col-lg-12 mt-5 my-4">
                                                   <div class="ml-auto mr-auto">
                                                       <nav aria-label="...">
                                                           <ul class="pagination pagination-lg">
                <#if (userArticlePageHelper.pageNo == 1)>
                <li class="page-item disabled" style="cursor: not-allowed">
                    <a class="page-link" href="javascript:void(0)" tabindex="-1">上一页</a>
                </li>
                <#else >
                 <li class="page-item ">
                     <a class="page-link" href="/user/PersonalSystem/articleList?pageNo=${userArticlePageHelper.pageNo-1}&pageSize=${userArticlePageHelper.pageSize}" tabindex="-1">上一页</a>
                 </li>
                </#if>
               <#list 1..(userArticlePageHelper.totalPage?number)!0 as data>
                <li class="page-item <#if (userArticlePageHelper.pageNo == (data_index+1)) > active</#if>"><a class="page-link" href="/user/PersonalSystem/articleList?pageNo=${data_index+1}&pageSize=${userArticlePageHelper.pageSize}">${data_index+1}</a></li>
               </#list>
                <#if (userArticlePageHelper.totalPage==userArticlePageHelper.pageNo)>
                <li class="page-item disabled" style="cursor: not-allowed">
                    <a class="page-link" href="javascript:void(0)">下一页</a>
                </li>
                <#else >
                 <li class="page-item " style="cursor: not-allowed">
                     <a class="page-link" href="/user/PersonalSystem/articleList?pageNo=${userArticlePageHelper.pageNo+1}&pageSize=${userArticlePageHelper.pageSize}">下一页</a>
                 </li>
                </#if>
                                                           </ul>
                                                       </nav>
