...
<div class="am-container am-text-truncate">
    ...
    <div class="am-input-group   am-u-md-7  am-u-sm-7 am-u-lg-7 am-u-sm-offset-1 am-u-md-offset-1">
        <input type="text" class="am-form-field" id="articleTitle" placeholder="请输入文章标题" value="${authArticle.a_Title}">
        ...
        <div class="am-btn-group am-hide-sm-only">
            ...
            <div class="am-dropdown" data-am-dropdown>
                ...
                <ul class="am-dropdown-content">
                    ...
                    <li class="am-divider"></li>
                    <li class="am-divider"></li>
                    <li><a href="/user/PersonalSystem/info">个人中心</a></li>
                    <li class="am-divider"></li>
                </ul>
            </div>
        </div>
    ...
    <div>
        <div class="editormd" id="test-editormd"><!-- 第二个隐藏文本域，用来构造生成的HTML代码，方便表单POST提交，这里的name可以任意取，后台接受时以这个name键为准 -->
            <textarea class="editormd-markdown-textarea" name="test-editormd-markdown-doc" id="content">${authArticle.a_text}</textarea>
            <textarea class="editormd-html-textarea" name="text" id="htmlContent"></textarea>
        </div>
    </div>
    <div class="am-modal am-modal-no-btn" tabindex="-1" id="doc-modal-1">
        <div class="am-modal-dialog">
            <div class="am-modal-hd">修改文章 文章id: <span id="a_id">${authArticle.a_id}</span>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="form-content">
                            ...
                            <input name="tags" readonly="readonly" id="tags"
                                   style="display: inline-block;height: 50px; width:50px;" value="
<#list  authArticle.tags as tags>
    ${tags.tag_name}
    <#sep >
    ,
</#list>" />
                        ...
                        <input name="tags" readonly="readonly" id="categorys"
                               style="display: inline-block;height: 50px; width:50px;" value="${authArticle.category.categoryname}"/>
                    </div>
                </div>
                <div class="am-modal-bd  foot" style="margin-top: 30px;">
                    <button class="am-btn am-btn-default am-round " data-am-modal-close type="button"
                            role="button">取消</button> <button class="am-btn am-btn-primary am-round" type="button"
                                                              id="btn-update" role="button">发布</button>
                </div>
            </form>
