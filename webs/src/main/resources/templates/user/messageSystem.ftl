        ...
        <ul class="sidebar-menu list-unstyled">
            <li class="sidebar-list-item py-3 "><a href="/user/MessageSystem/LikeNotification"
                ...
                <i class="zi zi_digg mr-3" zico="用户设置"></i><span>点赞</span><#if (unMarkRead_Like > 0)><span
                    class="badge badge-danger" id="unmarkreadLike"
            ...
            <li class="sidebar-list-item py-3"><a href="javascript: void (0)"
                ...
                <i class="zi zi_commentdots mr-3 text-gray"></i><span class="type" id="comment">评论 </span> <#if (unMarkRead_Comment > 0)><span
                    class="badge badge-danger" id="unmarkread"
                    style="position: relative;bottom: 10px;left: 2px;">${unMarkRead_Comment}</span>
            </#if>
            </a>
            </li>
            <li class="sidebar-list-item py-3"><a href="/user/MessageSystem/systemNotification"
                                                  class="sidebar-link text-muted">
                <i class="zi zi_home mr-3 text-gray"></i><span>系统通知</span><#if (unMarkRead_System > 0)>
    <span
            class="badge badge-danger" id="unmarkreadSystem"
            style="position: relative;bottom: 10px;left: 2px;">${unMarkRead_System}
            </#if>
            </span>
            </a>
            </li>
                                    ...
                                    <div id="personalDate" class="my-3">
                                        <div class="personalupdate  pb-5 pt-5">
                                            <div class="msg-info  col-sm-12 col-xd-12">
                                                未读消息 : <span id="unMarkReadCount"> ${unMarkRead_Comment}</span>
                                                <#if (comment_replyNotice?size>0 && unMarkRead_Comment > 0) >
                                                <div style="float: right;"><a href="javascript: void(0)"
                                                                              id="markRead">全部标记为已读</a>
                                                    <i id="pump">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;</i>
                                                    <a href="javascript: void(0)" id="clear">清空所有消息</a>
                                                </div>
                                                <#elseif (comment_replyNotice?size>0&&unMarkRead_Like==0)>
                                                     <div style="float: right;">
                                                         <a href="javascript: void(0)" id="clear">清空所有消息</a>
                                                     </div>
                                                </#if>
                                            </div>
                                            <div class="msg-list col-sm-12 col-xd-12  my-3 " id="${comment_replyNotice?size}"
                                                 style="position: relative;">
                                                 <#if (comment_replyNotice?size > 0)>
                                                     <ul>
                                                    <#list comment_replyNotice as commentNotice>
                                                        <#if (commentNotice.markRead==false)>
                                                       <span class="icon-red-dot" style="
                                                        ...
                                                        <li>
                                                            <div class="badge badge-info" style="font-size: 15px;">博客</div>
                                                            <span class="msg-title col-sm-10 col-xd-10"><a
                                                                    href="/user/showUser/${commentNotice.user.userName}"
                                                                    class=" userName">${commentNotice.user.userName}</a>
                                                            <#if (commentNotice.type=="评论")>
                                                                ${commentNotice.type}了你的文章
                                                            <#else >
                                                                ${commentNotice.type}了你的评论
                                                            </#if>
                                                            <a
                                                                    href="javascript:void(0)" class="mr-2"
                                                                    style="float: right;"><i class="zi zi_trashalt"
                                                                                             id="${commentNotice.article_comment_Notification_id}"
                                                                                             onclick="clearOne(this)"
                                                                                             zico="垃圾箱竖条"></i></a></span>
                                                            <p class="msg-text"><span><a
                                                                    href="/article/${commentNotice.articleId}"
                                                                    class="articleName">${commentNotice.commentContent}</a></span><em
                                                                    class="mr-2"
                                                                    style="float: right;">${(commentNotice.createTime?string)?replace("T"," ")?datetime("yyyy-MM-dd HH:mm:ss")}</em>
                                                            </p>
                                                        </li>
                                                        <#sep >
                                                    <hr>
