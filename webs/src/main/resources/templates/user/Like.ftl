    ...
    <div id="sidebar" class="sidebar py-3 ">
        ...
        <ul class="sidebar-menu list-unstyled">
            <li class="sidebar-list-item py-3 "><a href="javascript: void (0)"
                ...
                <i class="zi zi_digg mr-3" zico="用户设置"></i><span class="type"
                                                                 id="like">点赞</span><#if (unMarkRead_Like > 0)><span
            ...
            <li class="sidebar-list-item py-3"><a href="/user/MessageSystem/Comment_ReplyNotification"
                ...
                <i class="zi zi_commentdots mr-3 text-gray"></i><span>评论 </span><#if (unMarkRead_Comment > 0)><span
                                    ...
                                    <div id="personalDate" class="my-3">
                                        <div class="personalupdate  pb-5 pt-5">
                                            <div class="msg-info col-sm-12 col-xd-12">
                                                未读消息 : <span id="unMarkReadCount"> ${unMarkRead_Like}</span>
                                                <#if (unMarkRead_Like > 0 && likeNotice?size > 0) >
                                                <div style="float: right;"><a href="javascript: void(0)" id="markRead">全部标记为已读</a>
                                                    <i id="pump">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;</i>
                                                    <a href="javascript: void(0)" id="clear">清空所有消息</a>
                                                </div>
                                                <#elseif (likeNotice?size>0&&unMarkRead_Like==0)>
                                                     <div style="float: right;">
                                                         <a href="javascript: void(0)" id="clear">清空所有消息</a>
                                                     </div>
                                                </#if>
                                            </div>
                                            <div class="msg-list col-sm-12 col-xd-12  my-3" id="${likeNotice?size}"
                                                 style="position: relative;">
                                                <#if (likeNotice?size > 0)>
                                                    <ul>
                                                        <#list likeNotice as notice>
                                                      <#if (notice.markRead==false)>
                                                        ...
                                                        border-radius: 50%;"></span>
                                                            ...
                                                            <li>
                                                                ...
                                                                <div class="badge badge-info" style="font-size: 15px;">
                                                                    博客
                                                                </div>
                                                                <span class="msg-title col"><a
                                                                        href="/user/showUser/${notice.user.userName}"
                                                                        class="userName">${notice.user.userName}</a>点赞了你的${notice.type}
                                                                    <a id="${notice.likeNotificationId}"
                                                                       onclick="clearOne(this)"
                                                                       href="javascript:void(0)"
                                                                       style="float: right;"><i
                                                                            class="zi zi_trashalt"
                                                                            zico="垃圾箱竖条"></i></a></span>
                                                                <p class="msg-text"><span><#if (notice.type=="文章")>
                                                                    <a
                                                                            href="/article/${notice.articleId}"
                                                                            target="_blank" class="articleName">
                                                                        ${notice.articleTitle}
                                                                    </a>
                                                                <#else >
                                                                    <a href="/article/${notice.articleId}"
                                                                       class="articleName">${notice.commentContent} </a>
                                                                </#if></span><em
                                                                        style="float: right;">${(notice.createTime?string)?replace("T"," ")?datetime("yyyy-MM-dd HH:mm:ss")}</em>
                                                                </p>
                                                            </li>
                                                          <#sep >
                                                        <hr>
