    ...
    <div class="d-flex align-items-stretch ">
        <div id="sidebar" class="sidebar py-3 ">
            ...
            <ul class="sidebar-menu list-unstyled">
                ...
                <li class="sidebar-list-item py-3"><a href="messageSystem.ftl" class="sidebar-link text-muted active" >
                ...
                <li class="sidebar-list-item py-3"><a href="leaveSay.ftl" class="sidebar-link text-muted">
                                ...
                                <div class="admin-content  ">
                                    <div class="userInfo my-3">
                                        <div id="personalDate" class="my-3">
                                            <div class="personalupdate ml-2 pb-5 pt-5">
                                                <div class="msg-info ml-2 col-sm-12 col-xd-12">
                                                    <span>未读消息 : 1</span>
                                                    <div style="float: right;"><a href="javascript: void(0)">全部标记为已读</a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href="javascript: void(0)" >清空所有消息</a></div>
                                                </div>
                                                <div class="msg-list ml-2 col-sm-12 col-xd-12  my-3" style="position: relative;" >
                                                    <ul  >
                                           ...
                                           <div class="badge badge-info">博客</div><span class="msg-title col-sm-10 col-xd-10"><a href="#" class=" userName">Weleness</a>评论了你的文章<a href="javascript:void(0)" class="mr-2" style="float: right;"><i class="zi zi_trashalt" zico="垃圾箱竖条"></i></a></span>
                                                          <p class="msg-text"><span><a href="#" class="articleName">轻松学，Java 中的代理模式及动态代理</a></span><em class="mr-2" style="float: right;">2020-2-1</em></p>
                                                        </li>
                                                        <hr>
                                                        <li>
                                                            <div class="badge badge-info">博客</div><span class="msg-title col-sm-10 col-xd-10"><a href="#" class=" userName">Weleness</a>回复了你的评论<a href="javascript:void(0)" class="mr-2" style="float: right;"><i class="zi zi_trashalt" zico="垃圾箱竖条"></i></a></span>
                                                            <p class="msg-text"><span><a href="#" class="articleName">轻松学，Java 中的代理模式及动态代理</a></span><em class="mr-2" style="float: right;">2020-2-1</em></p>
                                                          </li>
                                                          <hr>
