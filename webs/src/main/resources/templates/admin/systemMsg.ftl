    ...
    <div class="d-flex align-items-stretch ">
        <div id="sidebar" class="sidebar py-3 ">
            ...
            <ul class="sidebar-menu list-unstyled">
                ...
                <li class="sidebar-list-item py-3"><a href="systemMsg.ftl" class="sidebar-link text-muted active">
                                        ...
                                        <div id="personalDate" class="my-3">
                                            <div class="personalupdate  pb-5 pt-5">
                                                ...
                                                <div class="msg-list col-sm-12 col-xd-12  my-3">
                                                    <ul >
                                                        <li>
                                                          <div class="badge badge-info">博客</div><span class="msg-title col">您的文章已通过审核：<a href="#" class="articleName">轻松学，Java 中的代理模式及动态代理</a></span><em style="float: right;">2020-2-1</em><a href="javascript:void(0)" style="float: right;"><i class="zi zi_trashalt" zico="垃圾箱竖条"></i></a></span>
                                                          <p class="msg-text"><span></p>
                                                        </li>
                                                        <hr>
                                                        <li>
                                                            <li>
                                                                <div class="badge badge-info">账号</div><span class="msg-title col">您的账号已被管理员锁定：<a href="#" class="badMsg">恶意评论</a></span><em style="float: right;">2020-2-1</em><a href="javascript:void(0)" style="float: right;"><i class="zi zi_trashalt" zico="垃圾箱竖条"></i></a></span>
                                                                <p class="msg-text"><span></p>
                                                              </li>
                                                          </li>
                                                          <hr>
