...
public interface IArticle_CommentDao {
     ...
     * @Return
     */
    @Insert("INSERT INTO tb_article_comment(comment_id,comment_text,comment_like_count,user_id,comment_time,article_id) VALUES(#{comment.commentId},#{comment.commentContent},#{comment.comment_like_count},#{comment.user.userId},#{comment.commentTime},#{comment.articleId})")
