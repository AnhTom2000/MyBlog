...
<body>
        ...
        <li class="sidebar-list-item"><a href="#" data-toggle="collapse" data-target="#items" aria-expanded="false"
          ...
          <div id="items" class="collapse">
            <ul class="sidebar-menu list-unstyled border-left border-primary border-thick">
              ...
              <li class="sidebar-list-item"><a href="/admin/commentAdmin" class="sidebar-link text-muted active pl-lg-5"><span><i
  ...
  <script src="https://weleness-1300955279.cos.ap-guangzhou.myqcloud.com/cdn/Blog/admin/js/admins/js/commentManger.js"></script>
</body>
