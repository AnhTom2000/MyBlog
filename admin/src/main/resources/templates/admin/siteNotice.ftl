...
<body>
  ...
  <div class="d-flex align-items-stretch">
    <div id="sidebar" class="sidebar py-3">
      ...
      <ul class="sidebar-menu list-unstyled">
        ...
        <li class="sidebar-list-item"><a href="/admin/userAdmin" data-toggle="collapse" data-target="#users" aria-expanded="false"
                ...
                <div class="card-body col-lg-12">
                  <div class="tab-content" id="tabContent">
                    <div id="toolbar" class="btn-group">
                      <button id="btn_add" type="button" class="btn btn-info btn-sm " data-toggle="modal"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLongTitle">新增公告</h5>
                ...
                <div class="userInfo my-3">
                    <div id="personalDate" class="my-3">
                        <div class="personalupdate pl-5 pb-5 pt-5">
                            ...
                            <label for="text">请输入公告内容 : </label>
                            </div>
                            <div class="personalDateForm">
                                <form id="personalDateForm">
                                  <textarea name="" id="siteNoticeContent" cols="30" rows="10"></textarea>
                                </form>
                            </div>
                        </div>
                    </div>
  ...
  <script src="https://weleness-1300955279.cos.ap-guangzhou.myqcloud.com/cdn/Blog/admin/js/admins/js/notice.js"></script>
</body>
