...
<div class="d-flex align-items-stretch">
    <div id="sidebar" class="sidebar py-3">
                ...
                <div id="items" class="collapse">
                    <ul class="sidebar-menu list-unstyled border-left border-primary border-thick">
                        <li class="sidebar-list-item"><a href="/admin/articleAdmin"
                                                         class="sidebar-link text-muted active pl-lg-5"><span><i
        ...
        <ul class="sidebar-menu list-unstyled">
            <li class="sidebar-list-item">
                <a href="#" data-toggle="collapse" data-target="#message" aria-expanded="false"
                   aria-controls="pages" class="sidebar-link text-muted"><i
    ...
    <div class="page-holder w-100 d-flex flex-wrap">
                            ...
                            <div class="card-body col-lg-12">
                                <div class="tab-content" id="tabContent">
                                    <div id="dateSearch" class="mb-5">
                                        ...
                                        <input type="text" class="mr-5" id="search-id" placeholder="请输入作者名字">
                                        <span><strong>標題 </strong></span>
                                        <input type="text" class="mr-5" id="search-name" placeholder="請輸入文章標題">
                                        <span><strong>分類： </strong></span>
                                        <select name="" id="search-select">
                                            <option value="1">原創</option>
                                            <option value="2">轉載</option>
                                            <option value="3">翻譯</option>
                                        </select>
                                        <button type="button" class="btn btn btn-info search ml-5" id="search"><i
        ...
        <!-- Modal -->
        <div class="modal fade" id="look" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
             aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">查看文章</h5>
...
<script src="https://weleness-1300955279.cos.ap-guangzhou.myqcloud.com/cdn/Blog/admin/js/admins/js/articleSetting.js"></script>
</body>
