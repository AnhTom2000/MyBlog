...
<div class="d-flex align-items-stretch">
    <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
            ...
            <li class="sidebar-list-item"><a href="#" data-toggle="collapse" data-target="#managers"
                                             aria-expanded="false"
                                             aria-controls="pages" class="sidebar-link text-muted"><i
        ...
        <ul class="sidebar-menu list-unstyled">
            <li class="sidebar-list-item"><a href="#" data-toggle="collapse" data-target="#message"
                                             aria-expanded="false"
                                             aria-controls="pages" class="sidebar-link text-muted"><i
            ...
            <li class="sidebar-list-item"><a href="#" data-toggle="collapse" data-target="#website"
                                             aria-expanded="false"
                                             aria-controls="pages" class="sidebar-link text-muted"><i
    ...
    <div class="page-holder w-100 d-flex flex-wrap">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">新增友链</h5>
                    ...
                    <div class="modal-body">
                                ...
                                <div id="personalDate" class="my-3">
                                    <div class="personalupdate pl-5 pb-5 pt-5">
                                        <div class="personalDateHeadPortrait">
                                            <label for="text">请输入友链内容 : </label>
                                        </div>
                                        <div class="form-group">
                                            <label for="linkName">友链名称</label>
                                            <input type="text" class="form-control" id="linkName" placeholder="请输入网站名称">

                                            <div class="form-group">
                                                <label for="href">网址</label>
                                                <input type="text" class="form-control" id="href" placeholder="请输入网址">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" id="comfrim">确定</button>
        ...
        <!-- Modal -->
        <div class="modal fade" id="updateLink" tabindex="-1" role="dialog"
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="admin-content pl-5 ">
                            <div class="userInfo my-3">
                                <div id="personalDate" class="my-3">
                                    <div class="personalupdate pl-5 pb-5 pt-5">
                                        <div class="personalDateHeadPortrait">
                                            <label for="text">友链 : </label>
                                        </div>
                                        <div class="form-group">
                                            <label for="link">友链名称</label>
                                            <input type="text" class="form-control" id="link" placeholder="请输入网站名称">

                                            <div class="form-group">
                                                <label for="linkHref">网址</label>
                                                <input type="text" class="form-control" id="linkHref" placeholder="请输入网址">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <script src="https://weleness-1300955279.cos.ap-guangzhou.myqcloud.com/cdn/Blog/admin/js/admins/js/friendLink.js"></script>
</body>
