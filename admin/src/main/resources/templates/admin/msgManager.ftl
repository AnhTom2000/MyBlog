                    ...
                    <div class="col-lg-12 ">
                        <div class="card mb-5 mb-lg-0 ">
                            <div class="card-body col-lg-12">
                                <div class="tab-content row d-flex" id="tabContent">
                                    ...
                                    <div class="col-lg-3 mr-5 ml-5">
                                        <label for="choose">选择通知方式 : </label>
                                        <div>
                                            <select id="choose">
                                                <option value="系统">系统通知</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <textarea class="my-5 ml-5" name="" id="content" cols="50" rows="10"
                                          placeholder="要发送什么消息呢"></textarea>
                                <button type="button" class="btn btn btn-info search my-5" id="send"><i
                                        class="fa fa-search"></i>发送
                                </button>
...
<script src="https://weleness-1300955279.cos.ap-guangzhou.myqcloud.com/cdn/Blog/admin/js/admins/js/msgManager.js"></script>
</body>
