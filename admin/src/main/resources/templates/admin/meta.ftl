...
<head>
  ...
  <!-- orion icons-->
    ...
    <link rel="stylesheet" href="https://weleness-1300955279.cos.ap-guangzhou.myqcloud.com/cdn/Blog/admin/js/admins/css/admin.css">
...
<body>
        ...
        <li class="sidebar-list-item"><a href="#" data-toggle="collapse" data-target="#items" aria-expanded="false"
          ...
          <div id="items" class="collapse">
            <ul class="sidebar-menu list-unstyled border-left border-primary border-thick">
              ...
              <li class="sidebar-list-item"><a href="/admin/questionAdmin" class="sidebar-link text-muted pl-lg-5"><span><i
                              ...
                              <div id="personalDate" class="my-3">
                                  <div class="personalupdate pl-5 pb-5 pt-5">
                                      <div class="personalDateHeadPortrait">
                                          <label for="text">meta关键字 : </label>
                                      </div>
                                      <div class="personalDateForm">
                                          <form id="personalDateForm">
                                              <textarea name="" id="metaKeyWord" cols="30" rows="10"></textarea>
                                          </form>
                                      </div>
                                  ...
                                  <div class="personalupdate pl-5 pb-5 pt-5">
                                      <div class="personalDateHeadPortrait">
                                          <label for="text">meta描述 : </label>
                                      </div>
                                      <div class="personalDateForm">
                                          <form id="personalDateForm">
                                              <textarea name="" id="metaDescription" cols="30" rows="10"></textarea>
                                          </form>
                                      </div>
                              ...
                              <div class="admin-content pl-5 ">
                                  <div class="userInfo my-3">
                                      <div id="personalDate" class="my-3">
                                          <div class="personalupdate pl-5 pb-5 pt-5">
                                              <div class="personalDateHeadPortrait">
                                                  <label for="text">版权 : </label>
                                              </div>
                                              <div class="personalDateForm">
                                                  <form id="personalDateForm">
                                                      <textarea name="" id="beianKeyWord" cols="30" rows="10"></textarea>
                                                  </form>
                                              </div>
                                          ...
                                          <div class="personalupdate pl-5 pb-5 pt-5">
                                              <div class="personalDateHeadPortrait">
                                                  <label for="text">备案信息 : </label>
                                              </div>
                                              <div class="personalDateForm">
                                                  <form id="personalDateForm">
                                                      <textarea name="" id="beianDescription" cols="30" rows="10"></textarea>
                                                  </form>
                                              </div>
  ...
  <script src="https://weleness-1300955279.cos.ap-guangzhou.myqcloud.com/cdn/Blog/admin/js/admins/js/meta.js"></script>
</body>
